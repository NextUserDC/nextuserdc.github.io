document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderEmptyState(query, isError = false) {
        ...
        const message = isError
            ? 'Ocurrió un error al buscar. Intenta nuevamente más tarde.'
            : 'No se encontraron resultados en tiendas oficiales.';
        ...
        googleLink.className = 'google-search-btn';
        ...
        path1.setAttribute('d', 'M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z');
        ...
        const googleLabel = document.createTextNode(` Buscar "${query}" en Google`);

        googleLink.appendChild(svg);
        googleLink.appendChild(googleLabel);

        emptyState.appendChild(messageParagraph);
        emptyState.appendChild(googleLink);
