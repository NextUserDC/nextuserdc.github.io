...
Página web personal dedicada con cuenta regresiva, mini-juego Wordle como mecanismo de desbloqueo, álbum de fotos y lista de Spotify embebida.
...
Servicio de correos temporales con dominio `@nextuser.lat`. Generación de direcciones personalizadas o aleatorias, bandeja de entrada en tiempo real, envío de correos, conexión multi-dispositivo mediante token y extensión de tiempo (24/48/72h).
